...
from maseval.benchmark.colbench.human_interaction_env import HumanInteractionEnv
from maseval.benchmark.colbench.vllm_agent import VLLMAgent
...
def main(
    ...
    if user_prompt_path == "auto":
        if task_type == "html":
            user_prompt_path = "maseval/benchmark/colbench/prompts/human_simulator_html_prompt.txt"
        else:
            user_prompt_path = "maseval/benchmark/colbench/prompts/human_simulator_code_prompt.txt"
    if agent_prompt_path == "auto":
        if task_type == "html":
            agent_prompt_path = "maseval/benchmark/colbench/prompts/llm_agent_html_prompt.txt"
        else:
            agent_prompt_path = "maseval/benchmark/colbench/prompts/llm_agent_code_prompt.txt"
    if task_type == "html":
