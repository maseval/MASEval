...
class TestCreateTools:
    ...
    def test_create_tools_from_specs(self, macs_model_factory, sample_environment_data):
    ...
    def test_create_tools_keyed_by_name(self, macs_model_factory, sample_environment_data):
    ...
    def test_create_tools_correct_properties(self, macs_model_factory, sample_environment_data):
...
class TestGetToolsForAgent:
    ...
    def test_get_tools_for_agent(self, macs_model_factory, sample_environment_data, sample_agent_spec_flight):
    ...
    def test_get_tools_for_agent_all(self, macs_model_factory, sample_environment_data, sample_agent_spec_all):
    ...
    def test_get_tools_for_agent_no_match(self, macs_model_factory, sample_environment_data, sample_agent_spec_none):
    ...
    def test_get_tools_for_agent_partial(self, macs_model_factory, sample_environment_data):
    ...
    def test_get_tools_for_agent_returns_same_instances(self, macs_model_factory, sample_environment_data, sample_agent_spec_flight):
    ...
    def test_get_tools_for_agent_empty_tools_list(self, macs_model_factory, sample_environment_data):
...
class TestMACSEnvironmentIntegration:
    ...
    def test_full_workflow(self, macs_model_factory, sample_environment_data):
    ...
    def test_tools_are_callable(self, sample_environment_data):
        ...
        env = MACSEnvironment(sample_environment_data, model_factory)
    ...
    def test_multiple_agents_share_tools(self, macs_model_factory, sample_environment_data):
...
class TestEdgeCases:
    ...
    def test_callbacks_passed_to_parent(self, macs_model_factory, sample_environment_data):
        ...
        env = MACSEnvironment(sample_environment_data, macs_model_factory, callbacks=callbacks)
